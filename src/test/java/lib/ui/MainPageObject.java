...
public class MainPageObject {
    ...
    public void swipeUpTillElementAppear(String locator, String error_message, int max_swipes)
    {
        ...
        while (!this.isElelementLocatedOnTheScreen(locator))
        {
            if(already_swiped > max_swipes){
                Assert.assertTrue(error_message, this.isElelementLocatedOnTheScreen(locator));
            }
    ...
    /*IOS Method*/
    public boolean isElelementLocatedOnTheScreen(String locator)
    {
